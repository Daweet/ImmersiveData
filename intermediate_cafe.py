"""This is the DataWork Cafe ordering app"""
...
# 'N' input will send user to goodbye message at end of program
if place_order.lower() == 'n':
    ordering = False
else:
    ordering = True

# will hold items and quantity for the order placed
user_order = {}
while ordering:
    ...
    # store the item and how many they want
    no_inventory = []
    for item_group in cafe_menu.values():
        # add 1 to list if requested item not in category group
    ...
    if order_again.lower() == 'y':
        ...
        for ordered_item, number_items in user_order.items():
            ...
            #subtotal += temp_price
            subtotal += (temp_price * number_items)
